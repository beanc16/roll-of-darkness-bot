...
export class QrMoveRangesStrategy
{
    public static key: PtuQuickReferenceInfo.MoveRanges = PtuQuickReferenceInfo.MoveRanges;

    public static async run(interaction: ChatInputCommandInteraction): Promise<boolean>
    {
        return await BaseQuickReferenceStrategy.run(interaction, this.key, 3);
    }
}
