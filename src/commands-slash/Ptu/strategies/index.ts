...
export class PtuStrategyExecutor extends BaseStrategyExecutor
{
    ...
    ): Promise<ApplicationCommandOptionChoiceData<string>[]>
    {
        ...
        const handlerMap: AutocompleteHandlerMap<PtuAutocompleteParameterName> = {
            ...
            [PtuAutocompleteParameterName.FakemonSpeciesName1]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName2]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName3]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName4]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName5]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName6]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName7]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName8]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName9]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName10]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName11]: () => PtuFakemonPseudoCache.getAll(userId),
            [PtuAutocompleteParameterName.FakemonSpeciesName12]: () => PtuFakemonPseudoCache.getAll(userId),
