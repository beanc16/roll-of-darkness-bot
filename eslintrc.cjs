...
module.exports = {
    ...
    overrides: [
        {   // Rules for...
            ...
            parserOptions: {
                project: [
                    './tsconfig.json',          // Required for: @typescript-eslint/recommended-requiring-type-checking
                    './tsconfig.test.json',     // Required for the below jest overrides to take effect for typescript files
                ],
            },
            rules: {
                // Spacing, Whitespace, Padding, Etc.
        ...
        },
        {
            ...
            // parserOptions: {
            //     project: [
            //         path.resolve(path.resolve(), 'tsconfig.test.json'),    // Required for the below jest overrides to take effect for typescript files
            //     ],
            // },
            rules: {
